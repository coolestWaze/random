import random
list = ("Aatrox", "Ahri", "Akali", "Akshan", "Alistar", "Amumu", "Anivia", "Annie", "Aphelios", "Ashe",
            "Aurelion Sol", "Aurora", "Azir", "Bardo", "Bel'Veth", "Blitzcrank", "Brand", "Braum", "Caitlyn", "Camille",
...
randomii = random.choice(list)
print (f'o proximo campeão para eu jogar será: {randomii}.')
